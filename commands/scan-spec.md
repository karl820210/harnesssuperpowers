---
description: "Invoke the superpowers:spec-scan skill to scan a spec for SDD compliance (CP-xx, preconditions, Wiring Matrix, BDD/TDD structure)."
argument_hint: "<spec-name-or-path>"
---

Invoke the `superpowers:spec-scan` skill against `$ARGUMENTS`.
